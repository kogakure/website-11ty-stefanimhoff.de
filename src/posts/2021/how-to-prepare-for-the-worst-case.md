...
If a virus can awake tribalism and hate in intelligent and peaceful people, what will starvation or fear of life through violence do?
...
The Stoics had techniques to train and prepare mentally and physically for potential future challenges. This makes one resilient and panic less likely if things go wrong. The Stoics were trained to eat basic food, wear basic clothes, or slip on the floor from time to time to train in this mindset. Hard physical work or demanding physical training are other good ways to toughen the body and mind. It helps to learn to be uncomfortable.

I tend to buy things in stock. Mostly out of laziness and convenience. I always use the same shampoo, why not buy three at once? Why not have things that hold longer times?

Since I was a teenager I have had a few items stored in my cellar that might be useful in bad times.
...
Other things might be natural disasters like floods or storms, social uprising, riots, disrupted supply chains[^roussinos2021dl] due to wars and catastrophes, or the prospect of a future war with China.
...
I did obligatory military service for nearly a year, learning to shoot with pistols and guns, crawling over wet meadows, and freezing in the snow in cold winter. I fell into a cold river while crawling in darkness through a forest. I didn’t like that either but don’t regret the experience. Germany discontinued obligatory military service, which is why younger people have no clue what I’m talking about.

## Preparing for an Emergency

Other countries like Austria or Switzerland prepare their population for such events.[^bundesheer2021dn] Germany doesn’t care, our politicians think all is fine and no action is needed. We don’t even get sirens running on the yearly catastrophe day. Austria produced a documentary[^hanslik2018wu] [^poet2019ss] that shows what happens during a blackout. The film mentions what an Austrian citizen should have to be prepared:
...
This list is a good start, but I decided to stock up more things. Parts of the equipment I own for more than 25 years, other things I bought last week.
...
- Apple Juice, _opened 6-month duration due to vacuum_ (25 l)
- Orange Juice (10 l)
- Breakfast Juice (6 l)
...
My most precious purchase is a portable {% affiliate "camping stove", "B083TMRWLP" %}. It’s small and can cook with wood and alcohol. I have a pack of {% affiliate "lighters", "B091ZN5DNV" %} and fire steel to start a fire. I have an easily flammable {% affiliate "wood block", "B007W1OEFW" %} to start a fire when it’s wet.

A {% affiliate "pot hanger", "B09DSXVL2G" %} allows me to hang a pod over an open fire. I bought {% affiliate "dry fuel", "B005NGMJLY" %} to survive the first few days before I need to chop wood.

For that I own a wood saw, a band saw and a set of {% affiliate "Tomahawks", "B08LN12J1V" %}. They are not the best to chop wood, but can also be used as a hammer, pick, and weapon. I’m thinking of buying a good ax.

I own a {% affiliate "Maglite", "B00XWPDS40" %} flashlight and a {% affiliate "radio", "B01CQCJFTG" %} with a crank that can produce bright light without any batteries.
...
I have two bicycles, an older mountain bike with a suspension fork and a new [Hyde Pro](https://archiv.cube.eu/2020/347200) city bike with a belt drive system. Those should be sufficient to leave the city when the energy is not restored after a week.
...
I own a [pocket radio](https://www.amazon.de/gp/product/B01CQCJFTG/) with crank, solar, and batteries. It supports all common frequencies and has built-in LED lights, a warning light, and a siren. It can load batteries via the sun or physical labor. This is useful because batteries are _always_ empty when you need a flashlight. But this one doesn’t need batteries, the crank is enough to get it running.
...
As I mentioned in the wood and fire section I bought two [Tomahawks](https://www.amazon.de/gp/product/B08LN12J1V/) which can be used as weapons.
...
My favorite books are the books of John Seymour. He was a British farmer and author who wrote fantastic, illustrated books like {% affiliate "The New Complete Book of Self-Sufficiency", "0241352460" %}, {% affiliate "New Self-Sufficient Gardener", "1409346781" %}, or {% affiliate "Forgotten Arts & Crafts", "0751327824" %}. These books teach how to be self-sufficient.
...
Another fantastic book project I supported on Indiegogo is [The Book](https://www.indiegogo.com/projects/the-book--28/x/26186498/). It’s a 400 page illustrated guide on how to rebuild civilization.

I own a version of [Der Reibert](https://www.amazon.de/Reibert-Das-Handbuch-deutschen-Soldaten/dp/3813207064/) from when I was in the military. It’s a useful book with thin paper with all information about warfare, survival, navigation, and more.

The Bushcraft series is another row of useful books I own: {% affiliate "Bushcraft 101", "B00MIMHPII" %} , {% affiliate "First Aid", "B01N4SB7FE" %}, {% affiliate "Trapping, Gathering, and Cooking in the Wild", "1440598525" %}, {% affiliate "Advanced", "B0108VCQV6" %}, and the {% affiliate "Illustrated", "1507209029" %} Visual Guide.
...
But I want to be is prepared. Civilization is sewn with a thin thread. It doesn’t harm to at least stock up some food and equipment for the worst case.
...
[^spiegel2017oz]: Der Spiegel (2017): _G20 in Hamburg: Eine Stadt im Ausnahmezustand_, <https://www.youtube.com/watch?v=ojToYs6nCnk>.
[^bundesheer2021dn]: Österreichs Bundesheer (2021): _Blackout - ein weiträumiger, eventuell gar europaweiter Stromausfall_, <https://www.youtube.com/watch?v=mHWcOQ_7Y-U>.
...
[^poet2019ss]: Paul Poet (2019): _Was passiert, wenn der Strom wirklich länger ausfällt_, <https://www.youtube.com/watch?v=UQR9xXNKojw>.
